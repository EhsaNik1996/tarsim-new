    ...
    <div className="relative w-full max-w-sm py-6 sm:py-10">
      <div className="relative mx-auto flex aspect-square w-full max-w-72 items-center justify-center">
        ...
        <svg aria-hidden="true" viewBox="0 0 288 288" fill="none" className="absolute inset-0 size-full">
          <rect x="28" y="28" width="232" height="232" rx="64" className="hero-preview-frame stroke-ink/8" strokeDasharray="3 7" />
          <path d="M28 92V64C28 44 44 28 64 28H92" className="hero-preview-line stroke-accent" strokeWidth="2" strokeLinecap="round" />
          <path d="M260 196V224C260 244 244 260 224 260H196" className="hero-preview-line stroke-cyan" strokeWidth="2" strokeLinecap="round" />
          <circle cx="260" cy="92" r="4" className="hero-preview-dot fill-green" />
          <circle cx="28" cy="196" r="4" className="hero-preview-dot fill-accent [animation-delay:-1.2s]" />
        </svg>
