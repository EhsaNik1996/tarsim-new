...
export function JoinBand() {
  return (
    <section className="relative isolate min-h-150 overflow-hidden bg-ink text-white py-28">
      <div className="absolute left-0 top-0 -z-10 w-full h-full opacity-35 mask-[linear-gradient(to_left,transparent_10%,black_70%)]">
        <Image
          src="/docibox-fullpage.png"
          alt="نمونه‌ای از محصول ساخته‌شده در ترسیم"
          fill
          sizes="100vw"
          className="object-cover object-top blur-sm transition duration-1000 hover:scale-105"
        />
      </div>
